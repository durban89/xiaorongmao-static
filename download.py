...
def main():
    ...
    parser.add_argument('--post-class', type=str, 
                        ...
                        help='包含封面图片的文章元素类名')
    parser.add_argument('--output-dir', type=str, default='./source/_posts', 
                        help='输出文件的目录')
    ...
    if analyzer.fetch_page():
        ...
        if cover_image:
            ...
            cover_image = "https://res.cloudinary.com/dy5dvcuc1/image/upload/v1595385476/xiaorongmao/golang.jpg"
            print("未找到封面图片")
